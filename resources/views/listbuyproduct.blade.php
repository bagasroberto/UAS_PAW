<x-guest-layout>
    <x-auth-card>
        ...
        <form method="POST" action="{{ url('listbuy/' . $product->id) }}" enctype="multipart/form-data">
            @csrf

            <x-label class="text-3xl text-center mt-3 mb-3" for="email" :value="__('Tambah Ke Keranjang')" />
            ...
            <div>
                ...
                <x-input
                    ...
                    type="text" name="id" value="{{ $product->id }}" readonly />
            </div>
